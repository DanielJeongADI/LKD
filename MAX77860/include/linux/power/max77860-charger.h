...
#ifndef __MAX77860_CHARGER_H__
#define __MAX77860_CHARGER_H__
...
#define BIT_DIS_USBC_CTRL			BIT(7)
...
#define REG_CHG_CNFG_05				0xBC
#define BIT_CHGIN_OVP				BITS(1, 0)
#define BIT_I_PREQUAL				BITS(3, 2)
#define BIT_CHGIN_PD_FS				BIT(4)
#define BIT_EN_THM_PRECHG			BIT(5)
...
struct max77860_charger_platform_data {
