 ...
 * Copyright (c) 2018, Maxim Integrated Product, Inc.  All rights reserved.
...
#include <linux/mfd/nvc.h>
#include <linux/mfd/max77387.h>
...
MODULE_AUTHOR("Steve Kim <steve.kim@maximintegrated.com>");
